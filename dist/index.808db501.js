...
})({"5RJAK":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "3c8b513e808db501";
"use strict";
...
},{}],"bXVSL":[function(require,module,exports) {
...
function showValue(input) {
    ...
    if (timeRangesArray === null) {
        document.getElementById("resultsDivTitle").getElementsByTagName("span")[0].innerHTML = "0 Range Found";
        ...
        for(let i = 0; i < durationsArray.length; i++)if (durationsArray[i] < 0) durationsArray[i] += 86400000;
        // Filter out the NaN values
        durationsArrCopy = durationsArray;
        if (durationsArrCopy.includes(NaN)) durationsArrCopy = durationsArrCopy.filter(function(value) {
            return !isNaN(value);
        });
        // Get the number of time ranges
        document.getElementById("resultsDivTitle").getElementsByTagName("span")[0].innerHTML = durationsArrCopy.length > 1 ? durationsArrCopy.length + " Ranges Found" : durationsArrCopy.length + " Range Found";
        // Get total hours
        const resultMillisec = durationsArrCopy.reduce(function(previousValue, currentValue) {
        ...
        // Do the table
        let tableObjsArr = [];
        for(let i1 = 0; i1 < durationsArray.length; i1++){
            let range = formattedRangesArray[i1]["start"].split(" ").join("") + " - " + formattedRangesArray[i1]["end"].split(" ").join("");
            let dur = formatMilliseconds(durationsArray[i1]);
            let tableObj = {
            };
...
function stringToTimeRanges(rawInput) {
    ...
    const regex = /\d{1,2}:+\d{1,2}\s?[aApP][mM]\s*[-—~–]\s*\d{1,2}:+\d{1,2}\s?[aApP][mM]/gm;
...
function formattedTimeStringToTime(formattedTimeString) {
    ...
    return _dateFns.getTime(_dateFns.parse(formattedTimeString, "p", new Date()));
}
...
function deleteAllRows(tableID) {
    ...
    if (rowCount > 1) {
        ...
        for(let i = tableHeaderRowCount; i < rowCount; i++)table.deleteRow(tableHeaderRowCount);
    }
...
},{"../_lib/requiredArgs/index.js":"d68zO","../constants/index.js":"iykpK","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["5RJAK","bXVSL"], "bXVSL", "parcelRequire94c2")

//# sourceMappingURL=index.808db501.js.map
